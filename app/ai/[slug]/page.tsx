    ...
    <main className="min-h-screen bg-[#f5f5f7] text-[#1d1d1f]">
      ...
      <div className="max-w-[430px] mx-auto px-4 py-4 pb-24">
        ...
        >
          ...
          <p className="text-sm opacity-80 leading-6 mb-5">
            {ai.description}
          </p>

          <div className="rounded-3xl bg-white/10 p-4 mb-3">
            <div className="text-xs opacity-70 mb-1">ユーザー評価</div>
            ...
            <div className="flex items-end justify-between">
              <div>
                ...
                <div className="text-xs opacity-70">Good率</div>
              </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="rounded-2xl bg-white/10 p-3 text-center">
              ...
              <div className="text-[10px] opacity-70">総投票</div>
            </div>
        ...
        <section className="bg-white rounded-3xl shadow-sm p-4 mb-5">
          <h2 className="font-bold mb-4">評価バランス</h2>
          ...
          <div className="grid grid-cols-2 gap-3 text-center text-sm">
            <div className="rounded-2xl bg-green-50 p-4">
              ...
              <div className="text-xs text-gray-500">Good数</div>
            </div>
            ...
            <div className="rounded-2xl bg-red-50 p-4">
              ...
              <div className="text-xs text-gray-500">Bad数</div>
            </div>
          </div>
        </section>
